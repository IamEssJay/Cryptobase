...
const Navbar = () => {
  ...
  return (
    <div className='roundes-div flex items-center justify-between h-20 font-bold'>
      <Link to='/'>
      ...
      'fixed left-[-100%] top-20 flex flex-col items-center justify-between w-full h-[90%] bg-primary ease-in duration-300 z-10 '
      }>
        ...
        <div className='flex flex-colw-full p-4'>
